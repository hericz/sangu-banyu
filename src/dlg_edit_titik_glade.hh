...
public:
        ...
        class Gtk::ComboBox * combo_hitung_a;
        class Gtk::ComboBox * combo_operator;
        class Gtk::ComboBox * combo_hitung_b;
        class Gtk::ComboBox * combo_waktu_a;
        class Gtk::ComboBox * combo_waktu_b;
