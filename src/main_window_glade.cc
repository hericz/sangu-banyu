// generated 2009/6/1 9:51:44 WIT by herry@LancarJaya.(none)
...
{  
   ...
   Gtk::Adjustment *spin_tanggal_adj = Gtk::manage(new class Gtk::Adjustment(1, 1, 31, 1, 1, 1));
   spin_tanggal = Gtk::manage(new class Gtk::SpinButton(*spin_tanggal_adj, 1, 0));
   
   Gtk::Adjustment *spin_bulan_adj = Gtk::manage(new class Gtk::Adjustment(1, 1, 12, 1, 1, 1));
   spin_bulan = Gtk::manage(new class Gtk::SpinButton(*spin_bulan_adj, 1, 0));
   
   Gtk::Adjustment *spin_tahun_adj = Gtk::manage(new class Gtk::Adjustment(2007, 2007, 2020, 1, 1, 1));
