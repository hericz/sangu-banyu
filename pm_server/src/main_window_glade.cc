...
{  main_window = this;
   ...
   combo_com = Gtk::manage(new class Gtk::ComboBox());
   
   Gtk::Label *label28 = Gtk::manage(new class Gtk::Label(_("Jumlah Power Meter ")));
   Gtk::Adjustment *spin_jumlah_pm_adj = Gtk::manage(new class Gtk::Adjustment(5, 0, 5, 1, 10, 10));
   spin_jumlah_pm = Gtk::manage(new class Gtk::SpinButton(*spin_jumlah_pm_adj, 1, 0));
   ...
   spin_jumlah_pm->set_flags(Gtk::CAN_FOCUS);
   spin_jumlah_pm->set_update_policy(Gtk::UPDATE_ALWAYS);
   spin_jumlah_pm->set_numeric(false);
   spin_jumlah_pm->set_digits(0);
   spin_jumlah_pm->set_wrap(false);
   ...
   table1->attach(*label28, 0, 1, 1, 2, Gtk::FILL, Gtk::AttachOptions(), 0, 0);
   table1->attach(*spin_jumlah_pm, 1, 2, 1, 2, Gtk::EXPAND|Gtk::FILL, Gtk::AttachOptions(), 0, 0);
